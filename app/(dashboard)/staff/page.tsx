          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="min-w-0">
              <div className="mb-2 flex items-start gap-3">
                <div className="shrink-0 rounded-xl bg-purple-100 p-2 dark:bg-purple-900/30">
            ...
            <div className="flex w-full min-w-0 flex-col gap-2 md:w-auto md:flex-row md:gap-3">
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-slate-300 px-5 py-2.5 font-medium transition-all hover:bg-slate-50 dark:border-slate-600 dark:hover:bg-slate-700 md:w-auto"
              >
              ...
              <button
                onClick={openAddForm}
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-purple-600 to-purple-700 px-5 py-2.5 font-medium text-white shadow-lg shadow-purple-500/30 transition-all hover:from-purple-700 hover:to-purple-800 md:w-auto"
              >
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
          <div className="group rounded-2xl border border-slate-200 bg-white p-4 transition-all duration-300 hover:shadow-lg dark:border-slate-700 dark:bg-slate-800 md:p-6">
            <div className="mb-3 flex items-center justify-between gap-3">
              <span className="text-sm font-semibold uppercase tracking-wide text-slate-600 dark:text-slate-400">Total Staff</span>
          ...
          <div className="group rounded-2xl border border-slate-200 bg-white p-4 transition-all duration-300 hover:shadow-lg dark:border-slate-700 dark:bg-slate-800 md:p-6">
            <div className="mb-3 flex items-center justify-between gap-3">
              <span className="text-sm font-semibold uppercase tracking-wide text-slate-600 dark:text-slate-400">Active Staff</span>
          ...
          <div className="group rounded-2xl border border-slate-200 bg-white p-4 transition-all duration-300 hover:shadow-lg dark:border-slate-700 dark:bg-slate-800 md:p-6">
            <div className="mb-3 flex items-center justify-between gap-3">
              <span className="text-sm font-semibold uppercase tracking-wide text-slate-600 dark:text-slate-400">On Leave</span>
          ...
          <div className="group rounded-2xl border border-slate-200 bg-white p-4 transition-all duration-300 hover:shadow-lg dark:border-slate-700 dark:bg-slate-800 md:p-6">
            <div className="mb-3 flex items-center justify-between gap-3">
              <span className="text-sm font-semibold uppercase tracking-wide text-slate-600 dark:text-slate-400">Teachers</span>
          ...
          <div className="flex flex-col gap-4 md:flex-row">
            <div className="relative min-w-0 flex-1">
              ...
              <input
                ...
                className="w-full rounded-xl border-2 border-slate-200 bg-white py-3 pl-12 pr-4 text-slate-900 transition-all placeholder:text-slate-400 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-50"
              />
            </div>
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-3 md:flex md:gap-3">
              <select
                ...
                className="w-full rounded-xl border-2 border-slate-200 bg-white px-4 py-3 font-medium text-slate-900 transition-all focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-50 md:w-auto"
              >
